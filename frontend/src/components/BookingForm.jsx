...
//     axios
//       .get(
//         `${import.meta.env.VITE_API_URL}/api/bookings/slots?date=${date}`
//       )
//       .then((res) => {
...
export default function BookingForm() {
  ...
  return (
    ...
    <section
      id="booking"
      className="bg-[#0b0b0b] py-20 px-5 md:px-8"
    >
          ...
          <div className="relative p-10 md:p-14 bg-[#0d0d0d] flex flex-col justify-between min-h-[760px] overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-400 leading-8 text-[15px] max-w-sm">
                ...
                Luxury grooming, modern cuts, beard styling
                and premium salon experience designed for
                confidence.
            ...
            <div className="max-w-lg mx-auto w-full">
              ...
              <div className="mb-10">
                ...
                <p className="text-gray-600 leading-7 text-[15px]">
                  ...
                  Choose your preferred service and
                  appointment slot for a premium salon visit.
              ...
              <div className="grid grid-cols-3 gap-4 mb-8">
                ...
                <button
                  ...
                  className={`rounded-[24px] p-5 border transition duration-300 ${
                    service === "Haircut"
